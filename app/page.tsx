...
const caseVisuals = {
  ...
  "https://aws.amazon.com/blogs/machine-learning/connect-amazon-bedrock-agentcore-to-cross-account-knowledge-bases/": { src: "/cases/cross-account-rag.png", alt: "AWS 跨账户知识库与 AgentCore 连接工程指南封面", caption: "短期角色和最小权限维持 Agent 与数据账户之间的隔离边界。" },
